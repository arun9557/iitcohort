...
export default function ProjectTable() {
  ...
  const handleDelete = async (id: string, projectOwner: string) => {
    ...
    <div className="bg-white rounded-lg shadow-sm p-6 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project) => {
          ...
          return (
            <div key={project.id} className="rounded-2xl shadow-md border border-gray-100 bg-white p-5 flex flex-col gap-3 hover:shadow-lg transition-all duration-200 group">
              ...
              <div className="flex gap-2 mt-2">
                ...
                {canDelete && (
                  <button
                    ...
                    onClick={() => handleDelete(project.id, project.owner)}
                    title="Delete"
                  >
      ...
      <button
        className="fixed bottom-8 right-8 bg-blue-600 text-white rounded-full shadow-lg p-4 flex items-center gap-2 hover:bg-blue-700 transition-all z-50 text-lg font-bold"
        onClick={() => openModal()}
        title="Add Project"
      >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 font-semibold disabled:opacity-60"
                >
