...
?>`
  ...
  const getSampleCode = (lang: string) => {
    return sampleCode[lang as keyof typeof sampleCode] || sampleCode.javascript;
  };
        ...
        <div className="flex overflow-x-auto border-b border-gray-700 p-2">
          {languages.map((lang) => (
            <button
              ...
              className={`px-3 py-2 text-sm font-medium transition whitespace-nowrap rounded mr-2 ${
